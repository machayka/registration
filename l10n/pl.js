OC.L10N.register(
    ...
    "The login name must not contain uppercase letters." : "Nazwa logowania nie może zawierać wielkich liter.",
    "The login name must not contain spaces." : "Nazwa logowania nie może zawierać spacji.",
    "The login name must not end with a dot." : "Nazwa logowania nie może kończyć się kropką.",
    ...
    "Email (optional)" : "E-mail (opcjonalny)",
    "Email" : "E-mail",
    "Continue" : "Kontynuuj",
    ...
    "Verify" : "Zweryfikuj",
    "If you have not received the code, please check your spam folder." : "Jeśli nie otrzymałeś kodu, sprawdź folder spam.",
    ...
    "We sent a message to the email address provided during registration." : "Wysłaliśmy wiadomość na adres e-mail podany przy rejestracji.",
    "Password reset" : "Resetowanie hasła",
    "Someone requested a password reset for your account. If it was not you – ignore this message." : "Ktoś poprosił o zresetowanie hasła do Twojego konta. Jeśli to nie Ty – zignoruj tę wiadomość.",
    "The link is valid for 1 hour." : "Link jest ważny przez 1 godzinę.",
    "The link is invalid or has expired." : "Link jest nieprawidłowy lub wygasł.",
    "The link has expired. Please try again." : "Link wygasł. Spróbuj ponownie.",
